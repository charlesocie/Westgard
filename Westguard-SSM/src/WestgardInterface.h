...
public:
	...
	EUpdateResult WGupdateWithNameAndStatement(const ERulesName ruleName, const bool statement);
    EUpdateResult WGupdateWithNameStatementAndValue(const ERulesName ruleName, const bool statement, const int value);
    EUpdateResult WGupdateEvaluateParameterizableRulesIf1_2sSucceed(const bool isActive);
